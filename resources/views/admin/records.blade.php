    ...
    <div class="col-12">
        <div class="card mt-2 mb-0">
            <div class="card-body card-head d-flex justify-content-between align-items-center p-2">
                <a class="btn m-0 p-0 arr" href="{{ route('records.changeMonth', ['direction' => 'previous', 'month' => $month, 'year' => $year]) }}">
                ...
                @if ($current == 0)
                <a class="btn m-0 p-0 arr" href="{{ route('records.changeMonth', ['direction' => 'next', 'month' => $month, 'year' => $year]) }}">
